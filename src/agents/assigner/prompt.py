...
prompt = ChatPromptTemplate.from_messages(
    [
        ...
        Quy tắc:
        - Nếu yêu cầu đơn giản (diễn đạt, viết lại, trả lời ngắn gọn) → trả về: writer
        ...
        QUAN TRỌNG:
        - Output chỉ được phép là duy nhất một trong các từ sau: "analyst", "coder", "planner", "search", "tool", "vision", "writer".
